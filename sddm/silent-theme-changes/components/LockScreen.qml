            ...
            Item {
                ...
                Repeater {
                    ...
                    delegate: Text {
                        ...
                        font.family: lockMessage.font.family
                        font.weight: lockMessage.font.weight
                        font.pixelSize: lockMessage.font.pixelSize
                        color: Config.lockMessageBorderColor
                        x: modelData.x
                        y: modelData.y
                    }
                }
