...
QtObject {
    ...
    property bool textHasBorder: config['text-has-border'] === "true" // @desc:Enable or disable border of text.
    ...
    property color clockBorderColor: config.stringValue("LockScreen.Clock/border-color") || "#1a1a1a" // @desc:Border color of clock.
    ...
    property color dateBorderColor: config.stringValue("LockScreen.Date/border-color") || "#1a1a1a" // @desc:Border color of date.
    ...
    property color lockMessageBorderColor: config.stringValue("LockScreen.Message/border-color") || "#1a1a1a" // @desc:Background color of the message border.
    ...
    property color usernameBorderColor: config.stringValue("LoginScreen.LoginArea.Username/border-color") || "#1a1a1a" // @desc:Border color of the username aka shadow.
    ...
    property color spinnerBorderColor: config.stringValue("LoginScreen.LoginArea.Spinner/border-color") || "#1a1a1a" // @desc:Border color of login spinner.
    ...
    property color warningMessageBorderColor: config.stringValue("LoginScreen.LoginArea.WarningMessage/border-color") || "#1a1a1a" // @desc:Border color of warning message.
