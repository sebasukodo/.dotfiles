                ...
                Item {
                    ...
                    Repeater {
                        ...
                        delegate: Text {
                            ...
                            font.family: activeUserName.font.family
                            font.weight: activeUserName.font.weight
                            font.pixelSize: activeUserName.font.pixelSize
                            color: Config.usernameBorderColor
                            x: modelData.x
                            y: modelData.y
                        }
                    }
                ...
                Item {
                    ...
                    Repeater {
                        ...
                        delegate: Text {
                            ...
                            font.family: loginMessage.font.family
                            font.weight: loginMessage.font.weight
                            font.pixelSize: loginMessage.font.pixelSize
                            color: Config.warningMessageBorderColor
                            x: modelData.x
                            y: modelData.y
                        }
                    }
